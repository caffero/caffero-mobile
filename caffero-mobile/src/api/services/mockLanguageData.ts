...
export const mockLocalizations: LocalizationMap = {
    en: [
        ...
        { id: 210, propertyName: 'coffeeScanCount', value: 'Coffee Scans', languageId: 'en' },
        { id: 211, propertyName: 'recipesSaved', value: 'Recipes Saved', languageId: 'en' },
        { id: 212, propertyName: 'beansSaved', value: 'Coffee Beans Saved', languageId: 'en' },
        { id: 213, propertyName: 'promotionCodes', value: 'Promotion Codes', languageId: 'en' },
        { id: 214, propertyName: 'summerSpecialPromo', value: 'Summer Special', languageId: 'en' },
        { id: 215, propertyName: 'firstPurchasePromo', value: 'First Purchase', languageId: 'en' },
        { id: 216, propertyName: 'weekendDealPromo', value: 'Weekend Deal', languageId: 'en' },
        { id: 217, propertyName: 'coffeeMastersRoastery', value: 'Coffee Masters', languageId: 'en' },
        { id: 218, propertyName: 'beanBrothersRoastery', value: 'Bean Brothers', languageId: 'en' },
        { id: 219, propertyName: 'roastHouseRoastery', value: 'Roast House', languageId: 'en' },

        // Promotion Code Detail Screen
        { id: 220, propertyName: 'promotionDetails', value: 'Promotion Details', languageId: 'en' },
        { id: 221, propertyName: 'useCode', value: 'Use Code', languageId: 'en' },
        { id: 222, propertyName: 'promotionCode', value: 'Promotion Code', languageId: 'en' },
        { id: 223, propertyName: 'discount', value: 'Discount', languageId: 'en' },
        { id: 224, propertyName: 'validUntil', value: 'Valid Until', languageId: 'en' },
        { id: 225, propertyName: 'termsAndConditions', value: 'Terms & Conditions', languageId: 'en' },
        { id: 226, propertyName: 'promotionSummerDescription', value: 'Get 25% off on all summer coffee blends. Perfect for cold brew and iced coffee lovers.', languageId: 'en' },
        { id: 227, propertyName: 'promotionWelcomeDescription', value: 'Welcome to Caffero! Enjoy 10% off on your first purchase of any coffee beans.', languageId: 'en' },
        { id: 228, propertyName: 'promotionWeekendDescription', value: 'Special weekend offer! Get 25% off on selected premium coffee beans.', languageId: 'en' },
        { id: 229, propertyName: 'promotionTerms', value: 'This promotion cannot be combined with other offers. Valid for one-time use only. The discount applies to the coffee beans price only, excluding shipping and handling fees.', languageId: 'en' },

        // Payment Screen
        { id: 230, propertyName: 'payment', value: 'Payment', languageId: 'en' },
        { id: 231, propertyName: 'premiumMembership', value: 'Premium Membership', languageId: 'en' },
        { id: 232, propertyName: 'month', value: 'month', languageId: 'en' },
        { id: 233, propertyName: 'cardNumber', value: 'Card Number', languageId: 'en' },
        { id: 234, propertyName: 'cardHolder', value: 'Card Holder', languageId: 'en' },
        { id: 235, propertyName: 'cardHolderPlaceholder', value: 'JOHN DOE', languageId: 'en' },
        { id: 236, propertyName: 'expiryDate', value: 'Expiry Date', languageId: 'en' },
        { id: 237, propertyName: 'cvv', value: 'CVV', languageId: 'en' },
        { id: 238, propertyName: 'subscribe', value: 'Subscribe Now', languageId: 'en' },
        { id: 239, propertyName: 'securePayment', value: 'Secure Payment Processing', languageId: 'en' },
        { id: 240, propertyName: 'paymentSuccess', value: 'Payment successful! Welcome to Premium!', languageId: 'en' },
    ...
    tr: [
        ...
        { id: 210, propertyName: 'coffeeScanCount', value: 'Kahve Taramaları', languageId: 'tr' },
        { id: 211, propertyName: 'recipesSaved', value: 'Kaydedilen Tarifler', languageId: 'tr' },
        { id: 212, propertyName: 'beansSaved', value: 'Kaydedilen Kahve Çekirdekleri', languageId: 'tr' },
        { id: 213, propertyName: 'promotionCodes', value: 'Promosyon Kodları', languageId: 'tr' },
        { id: 214, propertyName: 'summerSpecialPromo', value: 'Yaz Özel', languageId: 'tr' },
        { id: 215, propertyName: 'firstPurchasePromo', value: 'İlk Alışveriş', languageId: 'tr' },
        { id: 216, propertyName: 'weekendDealPromo', value: 'Hafta Sonu Fırsatı', languageId: 'tr' },
        { id: 217, propertyName: 'coffeeMastersRoastery', value: 'Coffee Masters', languageId: 'tr' },
        { id: 218, propertyName: 'beanBrothersRoastery', value: 'Bean Brothers', languageId: 'tr' },
        { id: 219, propertyName: 'roastHouseRoastery', value: 'Roast House', languageId: 'tr' },

        // Promotion Code Detail Screen
        { id: 220, propertyName: 'promotionDetails', value: 'Promosyon Detayları', languageId: 'tr' },
        { id: 221, propertyName: 'useCode', value: 'Kodu Kullan', languageId: 'tr' },
        { id: 222, propertyName: 'promotionCode', value: 'Promosyon Kodu', languageId: 'tr' },
        { id: 223, propertyName: 'discount', value: 'İndirim', languageId: 'tr' },
        { id: 224, propertyName: 'validUntil', value: 'Son Geçerlilik', languageId: 'tr' },
        { id: 225, propertyName: 'termsAndConditions', value: 'Şartlar ve Koşullar', languageId: 'tr' },
        { id: 226, propertyName: 'promotionSummerDescription', value: 'Tüm yaz kahve harmanlarında %25 indirim. Soğuk demleme ve buzlu kahve severler için mükemmel.', languageId: 'tr' },
        { id: 227, propertyName: 'promotionWelcomeDescription', value: 'Caffero\'ya hoş geldiniz! İlk kahve çekirdeği alışverişinizde %10 indirim.', languageId: 'tr' },
        { id: 228, propertyName: 'promotionWeekendDescription', value: 'Özel hafta sonu teklifi! Seçili premium kahve çekirdeklerinde %25 indirim.', languageId: 'tr' },
        { id: 229, propertyName: 'promotionTerms', value: 'Bu promosyon diğer tekliflerle birleştirilemez. Tek kullanımlıktır. İndirim yalnızca kahve çekirdeği fiyatına uygulanır, kargo ve işlem ücretleri hariçtir.', languageId: 'tr' },

        // Payment Screen
        { id: 230, propertyName: 'payment', value: 'Ödeme', languageId: 'tr' },
        { id: 231, propertyName: 'premiumMembership', value: 'Premium Üyelik', languageId: 'tr' },
        { id: 232, propertyName: 'month', value: 'ay', languageId: 'tr' },
        { id: 233, propertyName: 'cardNumber', value: 'Kart Numarası', languageId: 'tr' },
        { id: 234, propertyName: 'cardHolder', value: 'Kart Sahibi', languageId: 'tr' },
        { id: 235, propertyName: 'cardHolderPlaceholder', value: 'AHMET YILMAZ', languageId: 'tr' },
        { id: 236, propertyName: 'expiryDate', value: 'Son Kullanma Tarihi', languageId: 'tr' },
        { id: 237, propertyName: 'cvv', value: 'CVV', languageId: 'tr' },
        { id: 238, propertyName: 'subscribe', value: 'Şimdi Abone Ol', languageId: 'tr' },
        { id: 239, propertyName: 'securePayment', value: 'Güvenli Ödeme İşlemi', languageId: 'tr' },
        { id: 240, propertyName: 'paymentSuccess', value: 'Ödeme başarılı! Premium\'a hoş geldiniz!', languageId: 'tr' },
